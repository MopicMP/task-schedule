...
> Schedule Python functions (cron-like)

[![PyPI version](https://badge.fury.io/py/task-schedule.svg)](https://pypi.org/project/task-schedule/)
...
# Basic usage
result = schedule("your input here")
print(result)
```
...
result = schedule("Hello World")

# Example 2: Batch processing
from task_schedule import batch
